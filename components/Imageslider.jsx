...
export default function Imageslider({ slug: defaultSlug }) {
  // نام slug را به defaultSlug تغییر دادم تا با item.slug تداخل نکند
  ...
  const items = [
    {
      ...
      width: 700,
      height: 500,
      slug: "keyboards", // فرض می‌کنیم این اسلاگ دسته‌بندی است
    },
    {
      src: "/image-2.png",
    ...
    // می‌توانید آیتم‌های بیشتری با اسلاگ‌های مختلف اضافه کنید
  ];
